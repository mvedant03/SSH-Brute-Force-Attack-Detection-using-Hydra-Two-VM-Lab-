...
- **Attacker (Kali Linux):** 192.168.1.162  
- **Target (Ubuntu):** 192.168.1.7  
...
This activity indicates a dictionary-based brute-force attack using Hydra.
...
⚠️ This strongly suggests account compromise
